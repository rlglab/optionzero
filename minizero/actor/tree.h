...
public:
    ...
    inline void setOptionChild(TreeNode* option_child) { option_child_ = option_child; }
    ...
    inline virtual TreeNode* getOptionChild() const { return option_child_; }
    inline virtual TreeNode* getParent() const { return parent_; }

protected:
    Action action_;
    int num_children_;
    TreeNode* first_child_;
    TreeNode* option_child_;
    TreeNode* parent_;
};
