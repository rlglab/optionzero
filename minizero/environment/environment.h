...
#elif GRIDWORLD
#include "gridworld.h"
typedef minizero::env::gridworld::GridWorldAction Action;
typedef minizero::env::gridworld::GridWorldEnv Environment;
typedef minizero::env::gridworld::GridWorldEnvLoader EnvironmentLoader;
#elif HAVANNAH
#include "havannah.h"
